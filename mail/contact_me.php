...
if(empty($_POST['name']) ||
 ...
 $to = 'cristiancamiloriverospachon@gmail.com'; // Add your email address inbetween the '' replacing yourname@yourdomain.com - This is where the form will send a message to.
